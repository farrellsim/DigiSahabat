...
const translations = {
  en: {
    ...
    settings: {
      title: "Settings",
      languageQS: "Quick Select: ",
      languageChange: "Change",
      voice: "Voice Assistance",
      voiceSub: "Hear instructions spoken aloud",
      notification: "Notifications",
      notificationSub: "Learning reminders & updates",
      textsize: "Text Size",
      textsizeSub: "Choose your preferred size",
      textsizeSmall: "Small Text",
      textsizeMedium: "Medium Text",
      textsizeLarge: "Large Text",
      account: "Account",
      accountSub: "Change PIN // username // phone",
      logout: "Log Out",
    },
  },
  ms: {
    ...
    settings: {
      title: "Tetapan",
      languageQS: "Pilihan Cepat: ",
      languageChange: "Tukar",
      voice: "Bantuan Suara",
      voiceSub: "Dengar arahan dibacakan dengan kuat",
      notification: "Pemberitahuan",
      notificationSub: "Peringatan pembelajaran & kemas kini",
      textsize: "Saiz Teks",
      textsizeSub: "Pilih saiz yang anda suka",
      textsizeSmall: "Teks Kecil",
      textsizeMedium: "Teks Sederhana",
      textsizeLarge: "Teks Besar",
      account: "Akaun",
      accountSub: "Tukar PIN // nama pengguna // nombor telefon",
      logout: "Log Keluar"
    },
  },
  zh: {
